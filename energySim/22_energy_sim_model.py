...
class EnergyModel:
    ...
    def __init__(self, EFgp, slack, costparams, mode="exogenous",
                 ...
                 cost_same_as_lp=False, lp_trajectory_file='23_results_lp_trajectories.json',
                 discount_rate=0.01):
    ...
    def load_lp_trajectories_from_file(self, filename):
        ...
        try:
            ...
            self.lp_dist = {t: 0.0 for t in self.technology[:15]}
        ...
        if self.mode == 'exogenous':
            ...
            for t in techs:
                ...
                year_idx = self.y - self.y0
                 # SMR and SMR2 deployment begins in 2030.
